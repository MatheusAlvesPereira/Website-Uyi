...
export default function Nav(){
  ...
  return <>
    <header className="header">
      ...
      <nav className={navtoggle?'navbarclicked': "nav"}>
      ...
      <svg onClick={handlenav} id="Menu" className="nav__menu" width="42" height="33" viewBox="0 0 42 33" fill="none" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
